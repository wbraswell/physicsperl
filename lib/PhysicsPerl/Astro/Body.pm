...
use constant SOLAR_RADIUS => my number $TYPED_SOLAR_RADIUS = 696_300;                 # kilometers, via Google
...
our PhysicsPerl::Astro::Body $jupiter = sub {
    ...
    $body->{vx}     = +1.660_076_642_744_036_94e-03 * DAYS_PER_YEAR();
    $body->{vy}     = +7.699_011_184_197_404_25e-03 * DAYS_PER_YEAR();
    $body->{vz}     = -6.904_600_169_720_630_23e-05 * DAYS_PER_YEAR();
    $body->{mass}   = +9.547_919_384_243_266_09e-04 * SOLAR_MASS();
...
our PhysicsPerl::Astro::Body $saturn = sub {
    ...
    $body->{vx}     = -2.767_425_107_268_624_11e-03 * DAYS_PER_YEAR();
    $body->{vy}     = +4.998_528_012_349_172_38e-03 * DAYS_PER_YEAR();
    $body->{vz}     = +2.304_172_975_737_639_29e-05 * DAYS_PER_YEAR();
    $body->{mass}   = +2.858_859_806_661_308_12e-04 * SOLAR_MASS();
...
our PhysicsPerl::Astro::Body $uranus = sub {
    ...
    $body->{vx}     = +2.964_601_375_647_616_18e-03 * DAYS_PER_YEAR();
    $body->{vy}     = +2.378_471_739_594_809_50e-03 * DAYS_PER_YEAR();
    $body->{vz}     = -2.965_895_685_402_375_56e-05 * DAYS_PER_YEAR();
    $body->{mass}   = +4.366_244_043_351_562_98e-05 * SOLAR_MASS();
...
our PhysicsPerl::Astro::Body $neptune = sub {
    ...
    $body->{vx}     = +2.680_677_724_903_893_22e-03 * DAYS_PER_YEAR();
    $body->{vy}     = +1.628_241_700_382_422_95e-03 * DAYS_PER_YEAR();
    $body->{vz}     = -9.515_922_545_197_158_70e-05 * DAYS_PER_YEAR();
    $body->{mass}   = +5.151_389_020_466_114_51e-05 * SOLAR_MASS();
...
# NEED FIX: remove this subroutine in favor of inlined code in init()???
