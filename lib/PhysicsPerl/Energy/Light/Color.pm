...
sub init
{
	...
	$self->{debugger} = WOOP::AutoMagickLoad::Debugger->new();
	$self->debugger->set("debug_file", "/tmp/woop/debug/PhysicsPerl_Energy_Light_Color.txt");
	$self->debugger->set("enable", "yes");
}
